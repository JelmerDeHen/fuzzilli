...
for (const v57 in "object") {
    ...
    const v126 = {deleteProperty:v61,set:v61,getPrototypeOf:v61,call:v61,preventExtensions:v61,isExtensible:v61,construct:v61,get:v61,ownKeys:v61,setPrototypeOf:1337,has:v61};
    const v128 = new Proxy(v60,v126);
    v128[1] = "MIN_VALUE";
}
}
