...
// v5 = .object(ofGroup: Object, withProperties: ["__proto__", "e", "c", "a"])
const v6 = typeof v5;
// v6 = .string
function v9(v10,v11) {
    ...
    do {
        ...
        // v51 = .object(ofGroup: Object, withProperties: ["length", "valueOf", "b", "__proto__"])
        const v52 = [v51];
        // v52 = .object(ofGroup: Array, withProperties: ["__proto__", "length", "constructor"], withMethods: ["slice", "some", "every", "concat", "fill", "keys", "copyWithin", "indexOf", "find", "reverse", "map", "unshift", "pop", "push", "reduce", "sort", "shift", "toString", "filter", "forEach", "includes", "flat", "splice", "toLocaleString", "flatMap", "entries", "findIndex", "reduceRight", "join", "lastIndexOf", "values"])
        const v53 = new WeakMap(v52);
        // v53 = .object(ofGroup: WeakMap, withProperties: ["__proto__"], withMethods: ["delete", "has", "get", "set"])
        v30.__proto__ = v53;
    } while (v21 < 8);
}
const v56 = [1337];
