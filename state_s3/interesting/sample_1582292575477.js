...
function v0(v1,v2) {
    for (const v4 in "boolean") {
        ...
        do {
            ...
            // v17 = .object(ofGroup: WeakMap, withProperties: ["__proto__"], withMethods: ["delete", "has", "get", "set"])
            const v18 = v17.set(v15);
            // v18 = .object(ofGroup: WeakMap, withProperties: ["__proto__"], withMethods: ["delete", "has", "get", "set"])
