...
try {
    ...
    // v25 = .object(ofGroup: Object, withProperties: ["setPrototypeOf", "deleteProperty", "has", "getOwnPropertyDescriptor", "preventExtensions", "construct", "isExtensible", "defineProperty", "call", "set", "__proto__"])
    const v27 = new Proxy(v23,v25);
    // v27 = .unknown
    const v28 = {c:v24,e:Proxy,__proto__:v24,toString:v25,...undefined,...v27,...v19};
    // v28 = .object(ofGroup: Object, withProperties: ["constructor", "c", "byteLength", "toString", "length", "e", "byteOffset", "__proto__", "buffer"], withMethods: ["reverse", "some", "set", "map", "includes", "every", "findIndex", "values", "reduce", "slice", "reduceRight", "fill", "entries", "find", "filter", "sort", "copyWithin", "forEach", "keys", "indexOf", "lastIndexOf", "join", "subarray"])
} catch(v30) {
}
}
