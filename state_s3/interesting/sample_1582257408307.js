    ...
    for (const v10 in "boolean") {
        ...
        function v18(v19,v20) {
            ...
            try {
                ...
                // v23 = .object(ofGroup: Function, withProperties: ["prototype", "__proto__", "name", "arguments", "caller", "constructor", "length"], withMethods: ["call", "apply", "bind"]) + .function([.anything...] => .unknown) + .constructor([.anything...] => .unknown)
                const v24 = {__proto__:v4,valueOf:"number",d:Boolean,b:10,length:v4,a:v23};
                // v24 = .object(ofGroup: Object, withProperties: ["valueOf", "b", "__proto__", "length"], withMethods: ["a", "d"])
            } catch(v25) {
            }
        }
        const v26 = v18(v17);
