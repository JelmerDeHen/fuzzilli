...
// v9 = .object(ofGroup: Object, withProperties: ["e", "length", "a", "__proto__", "toString"], withMethods: ["d"])
let v10 = "unscopable";
...
// v53 = .object(ofGroup: Object, withProperties: ["length", "e", "valueOf", "b", "__proto__", "a"])
let v56 = undefined;
const v59 = new Int32Array(16675);
// v59 = .object(ofGroup: Int32Array, withProperties: ["__proto__", "constructor", "length", "byteOffset", "byteLength", "buffer"], withMethods: ["sort", "forEach", "filter", "fill", "lastIndexOf", "reduce", "map", "reduceRight", "find", "keys", "every", "set", "join", "values", "subarray", "copyWithin", "slice", "indexOf", "reverse", "entries", "findIndex", "some", "includes"])
...
for (const v65 in "object") {
    ...
    // v66 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["construct", "has", "getPrototypeOf", "preventExtensions", "apply", "setPrototypeOf", "isExtensible", "getOwnPropertyDescriptor", "toString", "deleteProperty"])
    ...
    // v69 = .object(ofGroup: Object, withProperties: ["construct", "isExtensible", "__proto__", "deleteProperty"], withMethods: ["preventExtensions", "a", "apply"])
    v68[v69] = Uint16Array;
}
v29 = v39;
