...
function v6(v7,v8) {
    for (const v10 in "boolean") {
        ...
        do {
            ...
            // v29 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["getOwnPropertyDescriptor", "construct", "preventExtensions", "deleteProperty", "ownKeys", "getPrototypeOf", "set", "isExtensible", "apply", "get", "defineProperty"])
