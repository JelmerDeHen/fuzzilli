...
function v3(v4,v5) {
    ...
    // v13 = .object(ofGroup: Object, withProperties: ["a", "__proto__", "c", "e", "d", "constructor"])
    ...
    // v21 = .object(ofGroup: Object, withProperties: ["constructor", "a", "__proto__", "length"], withMethods: ["toString"])
    ...
    // v33 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["getOwnPropertyDescriptor", "apply", "construct", "set", "isExtensible", "ownKeys", "preventExtensions", "setPrototypeOf", "defineProperty", "has", "deleteProperty"])
    const v35 = new Proxy(v21,v33);
    // v35 = .unknown
    const v36 = v35[4088076774];
    // v36 = .unknown
    const v37 = {e:DataView,constructor:1337,valueOf:1337,d:v12};
    // v37 = .object(ofGroup: Object, withProperties: ["d", "e", "constructor", "valueOf", "__proto__"])
    let v43 = 0;
    const v44 = v43 + 1;
    // v44 = .primitive
