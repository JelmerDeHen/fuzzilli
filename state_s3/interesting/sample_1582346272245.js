...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v17 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["construct", "isExtensible", "deleteProperty", "getPrototypeOf", "preventExtensions", "call", "set", "get", "ownKeys", "setPrototypeOf", "has"])
