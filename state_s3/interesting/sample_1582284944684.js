...
do {
    ...
    // v18 = .object(ofGroup: Object, withProperties: ["__proto__", "toString", "length"])
    let v19 = 1337;
    let v22 = "qHZ9xy0D+R";
    const v23 = v19[v22];
    // v23 = .unknown
    const v24 = new Float32Array(v18);
    // v24 = .object(ofGroup: Float32Array, withProperties: ["length", "constructor", "buffer", "__proto__", "byteLength", "byteOffset"], withMethods: ["slice", "some", "findIndex", "reduce", "copyWithin", "reverse", "find", "sort", "indexOf", "filter", "keys", "map", "every", "reduceRight", "lastIndexOf", "fill", "set", "forEach", "subarray", "entries", "values", "includes", "join"])
