...
function v0(v1,v2) {
    for (const v4 in "boolean") {
        ...
        do {
            ...
            // v11 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["defineProperty", "get", "preventExtensions", "construct", "getPrototypeOf", "ownKeys", "deleteProperty", "getOwnPropertyDescriptor", "isExtensible", "apply", "set"])
