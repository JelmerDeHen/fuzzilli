...
function v2(v3,v4) {
    ...
    // v12 = .object(ofGroup: Object, withProperties: ["__proto__", "a", "c", "d", "e", "constructor"])
    const v13 = {e:DataView,constructor:1337,valueOf:1337,d:v11};
    // v13 = .object(ofGroup: Object, withProperties: ["valueOf", "d", "__proto__", "e", "constructor"])
    ...
    for (const v24 in "boolean") {
        ...
        do {
            try {
                ...
                // v40 = .object(ofGroup: Object, withProperties: ["valueOf", "e", "length", "__proto__", "d"])
                let v41 = v40;
                const v42 = v41 + 1;
                // v42 = .primitive
                v41 = v42;
