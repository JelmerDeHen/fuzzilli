...
function v6(v7,v8) {
    ...
    // v42 = .object(ofGroup: Set, withProperties: ["__proto__", "size"], withMethods: ["entries", "has", "values", "add", "delete", "forEach", "keys", "clear"])
    ...
    // v81 = .object(ofGroup: Object, withProperties: ["length", "__proto__", "constructor", "d", "valueOf"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
