...
function v8(v9,v10) {
    ...
    function v14(v15,v16) {
        for (const v18 in "boolean") {
            ...
            // v38 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["setPrototypeOf", "call", "set", "has", "construct", "preventExtensions", "getPrototypeOf", "get", "deleteProperty", "isExtensible", "ownKeys"])
            v5 = v38;
            ...
            // v42 = .object(ofGroup: Uint16Array, withProperties: ["__proto__", "byteOffset", "length", "constructor", "buffer", "byteLength"], withMethods: ["entries", "join", "lastIndexOf", "forEach", "filter", "slice", "reduce", "reverse", "findIndex", "keys", "fill", "map", "every", "set", "reduceRight", "includes", "sort", "find", "subarray", "indexOf", "values", "some", "copyWithin"])
            v42[1] = "MIN_VALUE";
        }
    }
