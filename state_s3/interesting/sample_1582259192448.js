...
function v1(v2,v3) {
    ...
    // v11 = .object(ofGroup: Object, withProperties: ["a", "c", "e", "constructor", "d", "__proto__"])
    ...
    // v17 = .object(ofGroup: Object, withProperties: ["__proto__", "length", "constructor", "a"], withMethods: ["toString"])
    let v18 = v17;
    ...
    const v29 = {constructor:13.37,length:13.37,__proto__:v22,toString:Number,a:"N0Xx92zvHQ"};
    // v29 = .object(ofGroup: Object, withProperties: ["constructor", "a", "__proto__", "length"], withMethods: ["toString"])
    let v32 = 0;
    do {
        const v33 = v18.__proto__;
        // v33 = .object()
        v18 = 1337;
        const v34 = v32 + 1;
        // v34 = .primitive
        v32 = v34;
        const v36 = {get:Number,set:v3};
        // v36 = .object(ofGroup: Object, withProperties: ["set", "__proto__"], withMethods: ["get"])
        const v38 = Object.defineProperty(v33,512,v36);
        // v38 = .undefined
        const v39 = v34 >= 512;
        // v39 = .boolean
        for (const v40 in Promise) {
            if (Promise) {
            } else {
            }
        }
