...
// v7 = .object(ofGroup: Object, withProperties: ["__proto__", "d", "a", "e"], withMethods: ["length"])
const v8 = {length:parseFloat,e:v3};
// v8 = .object(ofGroup: Object, withProperties: ["__proto__", "e"], withMethods: ["length"])
const v13 = [13.37,13.37,13.37];
// v13 = .object(ofGroup: Array, withProperties: ["constructor", "length", "__proto__"], withMethods: ["toString", "push", "find", "sort", "keys", "flat", "forEach", "lastIndexOf", "concat", "reverse", "indexOf", "toLocaleString", "splice", "reduceRight", "shift", "entries", "slice", "pop", "findIndex", "every", "unshift", "map", "flatMap", "includes", "fill", "reduce", "copyWithin", "filter", "join", "some", "values"])
const v14 = {toString:Uint8Array,d:"symbol",c:v13,a:13.37};
// v14 = .object(ofGroup: Object, withProperties: ["toString", "__proto__", "c", "a", "d"])
