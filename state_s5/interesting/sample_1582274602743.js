...
const v3 = {__proto__:13.37,constructor:v2,d:13.37,toString:1337};
// v3 = .object(ofGroup: Object, withProperties: ["constructor", "d", "toString", "__proto__"])
const v4 = {length:v3,e:13.37,b:v3};
// v4 = .object(ofGroup: Object, withProperties: ["e", "length", "__proto__", "b"])
let v7 = 0;
do {
    const v9 = [1337];
