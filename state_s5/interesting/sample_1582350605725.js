...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v30 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["isExtensible", "deleteProperty", "get", "setPrototypeOf", "preventExtensions", "set", "getPrototypeOf", "construct", "has", "ownKeys", "call"])
