...
function v6(v7,v8) {
    ...
    // v42 = .object(ofGroup: Set, withProperties: ["size", "__proto__"], withMethods: ["has", "clear", "values", "delete", "add", "keys", "entries", "forEach"])
    ...
    // v81 = .object(ofGroup: Object, withProperties: ["d", "__proto__", "constructor", "valueOf", "length"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
