...
// v5 = .object(ofGroup: Object, withProperties: ["c", "a", "__proto__", "e"])
const v6 = typeof v5;
// v6 = .string
function v9(v10,v11) {
    ...
    do {
        ...
        // v51 = .object(ofGroup: Object, withProperties: ["valueOf", "__proto__", "length", "b"])
        const v52 = [v51];
        // v52 = .object(ofGroup: Array, withProperties: ["constructor", "length", "__proto__"], withMethods: ["toString", "push", "find", "sort", "keys", "flat", "forEach", "lastIndexOf", "concat", "reverse", "indexOf", "toLocaleString", "splice", "reduceRight", "shift", "entries", "slice", "pop", "findIndex", "every", "unshift", "map", "flatMap", "includes", "fill", "reduce", "copyWithin", "filter", "join", "some", "values"])
        const v53 = new WeakMap(v52);
        // v53 = .object(ofGroup: WeakMap, withProperties: ["__proto__"], withMethods: ["get", "delete", "has", "set"])
        v30.__proto__ = v53;
    } while (v21 < 8);
}
const v56 = [1337];
