...
// v10 = .object(ofGroup: Float32Array, withProperties: ["length", "__proto__", "byteOffset", "constructor", "buffer", "byteLength"], withMethods: ["subarray", "values", "reverse", "fill", "keys", "reduceRight", "join", "find", "every", "forEach", "sort", "includes", "set", "slice", "filter", "entries", "copyWithin", "lastIndexOf", "map", "findIndex", "some", "indexOf", "reduce"])
const v12 = v10.includes(0,0);
// v12 = .boolean
const v13 = {e:13.37,__proto__:v4,valueOf:13.37};
// v13 = .object(ofGroup: Object, withProperties: ["__proto__", "e", "valueOf"])
...
for (const v21 in v15) {
    try {
        const v22 = typeof -2191158840;
        // v22 = .string
        const v24 = v22 === "undefined";
        // v24 = .boolean
        const v25 = v19.toLocaleString(v21,v24,1337);
