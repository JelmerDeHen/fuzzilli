...
// v9 = .object(ofGroup: Object, withProperties: ["constructor", "toString", "__proto__", "valueOf", "b", "e"])
let v10 = "boolean";
const v13 = [13.37,13.37,-4294967297,13.37];
// v13 = .object(ofGroup: Array, withProperties: ["constructor", "length", "__proto__"], withMethods: ["toString", "push", "find", "sort", "keys", "flat", "forEach", "lastIndexOf", "concat", "reverse", "indexOf", "toLocaleString", "splice", "reduceRight", "shift", "entries", "slice", "pop", "findIndex", "every", "unshift", "map", "flatMap", "includes", "fill", "reduce", "copyWithin", "filter", "join", "some", "values"])
const v16 = new Float32Array(53664);
...
// v27 = .object(ofGroup: Object, withProperties: ["constructor", "__proto__", "c", "e", "a", "d"])
...
for (const v42 in "boolean") {
    ...
    do {
        let v46 = 0;
        try {
            const v47 = v31.length;
            // v47 = .integer
            v13.length = 0;
            const v49 = v38(..."boolean",v18,...v27,...v47,...v46);
            // v49 = .unknown
        } catch(v50) {
        }
        const v54 = v45 + 1;
...
if (v64) {
    ...
    const v67 = {e:v38,length:v27,b:"boolean",toString:v9,..."boolean",...v41,...gc,..."boolean",...v8};
    // v67 = .object(ofGroup: Object, withProperties: ["__proto__", "b", "constructor", "length", "e", "toString"], withMethods: ["concat", "startsWith", "lastIndexOf", "split", "includes", "trim", "padStart", "indexOf", "substring", "slice", "replace", "repeat", "charCodeAt", "padEnd", "endsWith", "codePointAt", "charAt"])
    v65 = v67;
}
const v68 = gc();
// v68 = .undefined
