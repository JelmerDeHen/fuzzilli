...
function v9(v10,v11) {
    for (const v13 in "boolean") {
        ...
        // v25 = .object(ofGroup: Object, withProperties: ["construct", "getPrototypeOf", "setPrototypeOf", "defineProperty", "set", "apply", "has", "deleteProperty", "isExtensible", "__proto__"], withMethods: ["getOwnPropertyDescriptor", "ownKeys", "get", "call"])
        ...
        for (const v33 in v25) {
            ...
            // v34 = .object(ofGroup: Object, withProperties: ["apply", "has", "__proto__", "preventExtensions"], withMethods: ["get", "setPrototypeOf", "getPrototypeOf"])
        }
    }
}
