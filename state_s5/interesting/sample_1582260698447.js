...
function v0(v1,v2) {
    ...
    // v8 = .object(ofGroup: Object, withProperties: ["__proto__", "length", "a", "constructor"], withMethods: ["toString"])
    let v9 = v8;
    const v12 = {get:gc};
    ...
    // v21 = .object(ofGroup: Object, withProperties: ["__proto__", "constructor", "d", "a", "e", "c"])
    ...
    // v37 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["preventExtensions", "isExtensible", "set", "deleteProperty", "getOwnPropertyDescriptor", "apply", "defineProperty", "construct", "ownKeys", "has", "setPrototypeOf"])
    const v39 = new Proxy(v29,v37);
    // v39 = .unknown
    const v40 = {e:DataView,constructor:1337,valueOf:1337,d:v20};
    // v40 = .object(ofGroup: Object, withProperties: ["__proto__", "constructor", "valueOf", "e", "d"])
    for (let v45 = 0; v45 < 10; v45++) {
        ...
        for (const v57 in "object") {
            ...
            // v60 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["constructor", "set"])
        }
    }
    let v63 = 0;
