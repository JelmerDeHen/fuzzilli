...
function v2(v3,v4) {
    ...
    const v9 = {valueOf:v8,b:Float64Array,__proto__:13.37};
    // v9 = .object(ofGroup: Object, withProperties: ["__proto__", "valueOf", "b"])
    const v11 = [371375.4036167406,371375.4036167406,371375.4036167406];
    // v11 = .object(ofGroup: Array, withProperties: ["constructor", "length", "__proto__"], withMethods: ["toString", "push", "find", "sort", "keys", "flat", "forEach", "lastIndexOf", "concat", "reverse", "indexOf", "toLocaleString", "splice", "reduceRight", "shift", "entries", "slice", "pop", "findIndex", "every", "unshift", "map", "flatMap", "includes", "fill", "reduce", "copyWithin", "filter", "join", "some", "values"])
    const v14 = {get:gc,set:gc};
    // v14 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["get", "set"])
    const v16 = Object.defineProperty(v11,"constructor",v14);
    // v16 = .undefined
