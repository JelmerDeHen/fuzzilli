...
// v5 = .object(ofGroup: Object, withProperties: ["a", "constructor", "__proto__"], withMethods: ["toString"])
let v6 = v5;
const v8 = {getPrototypeOf:Number,setPrototypeOf:Number,preventExtensions:Number,apply:Number,ownKeys:Number};
// v8 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["preventExtensions", "setPrototypeOf", "getPrototypeOf", "ownKeys", "apply"])
