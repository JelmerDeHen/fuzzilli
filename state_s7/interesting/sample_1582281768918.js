...
// v21 = .object(ofGroup: Object, withProperties: ["b", "__proto__", "valueOf", "c"])
const v23 = new Map(v21);
// v23 = .object(ofGroup: Map, withProperties: ["__proto__", "size"], withMethods: ["values", "set", "keys", "delete", "entries", "clear", "get", "has", "forEach"])
}
