...
// v28 = .object(ofGroup: Object, withProperties: ["__proto__", "length", "e", "a", "b", "valueOf"])
...
let v45 = v19;
with ("N0Xx92zvHQ") {
    for (const v47 of "N0Xx92zvHQ") {
        v47.d = v45;
    }
    for (const v48 in v19) {
        for (const v49 in v17) {
        }
    }
}
}
