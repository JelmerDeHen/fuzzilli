...
// v9 = .object(ofGroup: Object, withProperties: ["d", "c", "valueOf", "e", "__proto__"])
const v10 = {a:v9,valueOf:v7,length:v7,d:v9,constructor:1337,__proto__:"Jkpn+sbYGJ",c:1337,e:v9};
// v10 = .object(ofGroup: Object, withProperties: ["e", "valueOf", "c", "d", "constructor", "__proto__", "a", "length"])
function v12(v13,v14) {
    ...
    // v27 = .object(ofGroup: Uint8Array, withProperties: ["constructor", "__proto__", "buffer", "length", "byteOffset", "byteLength"], withMethods: ["copyWithin", "includes", "reduceRight", "reverse", "indexOf", "fill", "findIndex", "set", "subarray", "sort", "forEach", "slice", "entries", "filter", "join", "every", "some", "keys", "lastIndexOf", "reduce", "values", "find", "map"])
    const v28 = v27[0];
    // v28 = .unknown
    const v30 = {set:gc};
