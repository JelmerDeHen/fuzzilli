...
function v0(v1,v2) {
    ...
    // v8 = .object(ofGroup: Object, withProperties: ["a", "length", "__proto__", "constructor"], withMethods: ["toString"])
    let v9 = v8;
    const v12 = {get:gc};
    ...
    // v21 = .object(ofGroup: Object, withProperties: ["constructor", "a", "c", "d", "__proto__", "e"])
    ...
    // v37 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["ownKeys", "preventExtensions", "set", "has", "apply", "defineProperty", "isExtensible", "construct", "getOwnPropertyDescriptor", "deleteProperty", "setPrototypeOf"])
    const v39 = new Proxy(v29,v37);
    // v39 = .unknown
    const v40 = {e:DataView,constructor:1337,valueOf:1337,d:v20};
    // v40 = .object(ofGroup: Object, withProperties: ["constructor", "valueOf", "__proto__", "d", "e"])
