function main() {
const v3 = new Int8Array("arguments");
...
const v5 = new Map(v3);
// v5 = .object(ofGroup: Map, withProperties: ["__proto__", "size"], withMethods: ["values", "set", "keys", "delete", "entries", "clear", "get", "has", "forEach"])
const v6 = v5.values(v3);
// v6 = .object()
for (const v8 in "boolean") {
    ...
    // v53 = .primitive
    v52 = v53;
    const v56 = new Int8Array(236809597);
