...
for (const v1 in "object") {
    ...
    function v5(v6,v7,v8,v9) {
        ...
        try {
            ...
            // v33 = .object(ofGroup: Object, withProperties: ["valueOf", "b", "c", "d", "constructor", "__proto__"])
            let v34 = v33;
            const v36 = "E".padEnd();
            ...
            const v48 = [v45,13.37,13.37];
            // v48 = .object(ofGroup: Array, withProperties: ["constructor", "__proto__", "length"], withMethods: ["pop", "flatMap", "push", "values", "toLocaleString", "indexOf", "copyWithin", "lastIndexOf", "find", "unshift", "keys", "toString", "findIndex", "some", "reduceRight", "reduce", "entries", "splice", "shift", "slice", "concat", "fill", "sort", "includes", "forEach", "filter", "every", "join", "flat", "reverse", "map"])
            const v49 = {length:1337,toString:v48,__proto__:v43};
            // v49 = .object(ofGroup: Object, withProperties: ["toString", "__proto__", "length"])
    ...
    const v53 = {deleteProperty:v5,set:v5,getPrototypeOf:v5,call:v5,preventExtensions:v5,isExtensible:v5,construct:v5,get:v5,ownKeys:v5,setPrototypeOf:1337,has:v5};
    // v53 = .object(ofGroup: Object, withProperties: ["__proto__", "setPrototypeOf"], withMethods: ["set", "has", "isExtensible", "ownKeys", "preventExtensions", "get", "deleteProperty", "construct", "getPrototypeOf", "call"])
    const v55 = new Proxy(v4,v53);
    // v55 = .unknown
    v55[1] = "MIN_VALUE";
}
const v57 = eval();
