...
// v5 = .object(ofGroup: Object, withProperties: ["toString", "__proto__", "d", "a"])
const v9 = [1337,1337];
// v9 = .object(ofGroup: Array, withProperties: ["constructor", "__proto__", "length"], withMethods: ["pop", "flatMap", "push", "values", "toLocaleString", "indexOf", "copyWithin", "lastIndexOf", "find", "unshift", "keys", "toString", "findIndex", "some", "reduceRight", "reduce", "entries", "splice", "shift", "slice", "concat", "fill", "sort", "includes", "forEach", "filter", "every", "join", "flat", "reverse", "map"])
const v10 = [1337,v9,"e",v9];
// v10 = .object(ofGroup: Array, withProperties: ["constructor", "__proto__", "length"], withMethods: ["pop", "flatMap", "push", "values", "toLocaleString", "indexOf", "copyWithin", "lastIndexOf", "find", "unshift", "keys", "toString", "findIndex", "some", "reduceRight", "reduce", "entries", "splice", "shift", "slice", "concat", "fill", "sort", "includes", "forEach", "filter", "every", "join", "flat", "reverse", "map"])
const v11 = {valueOf:"e",length:1337,a:v9,b:v9,e:1337};
// v11 = .object(ofGroup: Object, withProperties: ["valueOf", "b", "__proto__", "e", "a", "length"])
const v14 = [];
...
function v19(v20,v21) {
    ...
    // v26 = .object(ofGroup: Object, withProperties: ["__proto__", "d", "constructor", "valueOf", "e"])
    let v28 = 0;
    let v31 = 0;
    do {
        try {
