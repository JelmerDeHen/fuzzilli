...
function v2(v3,v4) {
    ...
    function v8(v9,v10) {
        for (const v12 in "boolean") {
            ...
            // v21 = .object(ofGroup: Object, withProperties: ["valueOf", "a", "__proto__"], withMethods: ["e"])
            function v23(v24,v25,v26,v27,...v28) {
                const v30 = [1337];
                // v30 = .object(ofGroup: Array, withProperties: ["constructor", "__proto__", "length"], withMethods: ["pop", "flatMap", "push", "values", "toLocaleString", "indexOf", "copyWithin", "lastIndexOf", "find", "unshift", "keys", "toString", "findIndex", "some", "reduceRight", "reduce", "entries", "splice", "shift", "slice", "concat", "fill", "sort", "includes", "forEach", "filter", "every", "join", "flat", "reverse", "map"])
                let v31 = v30;
                const v32 = {b:1337,e:v31,length:v21,__proto__:v23,d:v26,...v23};
                // v32 = .object(ofGroup: Object, withProperties: ["d", "b", "__proto__", "e", "length"], withMethods: ["__proto__"])
            }
            const v33 = v23(1337);
            // v33 = .unknown
        }
