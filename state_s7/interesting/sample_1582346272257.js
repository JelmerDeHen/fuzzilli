...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v17 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["get", "ownKeys", "setPrototypeOf", "set", "call", "getPrototypeOf", "deleteProperty", "construct", "has", "preventExtensions", "isExtensible"])
