...
const v5 = [v4];
const v6 = {length:v4,toString:v5,c:"function",a:v5,constructor:13.37,b:v5,__proto__:1337};
const v7 = {valueOf:v2,__proto__:13.37,c:1337,e:v2,length:1337,constructor:v5};
let v8 = v6;
...
const v76 = [1337];
const v77 = {__proto__:parseFloat,a:v76,toString:"byteLength",length:13.37};
const v80 = [1337,1337,1337,1337,ArrayBuffer];
...
const v88 = new Proxy(v80,v86);
const v90 = new Proxy(v18,v71);
v90[1] = "MIN_VALUE";
}
