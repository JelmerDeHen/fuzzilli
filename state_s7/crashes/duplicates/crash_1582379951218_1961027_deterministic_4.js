...
for (const v1 in "object") {
    const v4 = [2066857228,2066857228,2066857228,2066857228,2066857228];
    ...
    const v53 = {deleteProperty:v5,set:v5,getPrototypeOf:v5,call:v5,preventExtensions:v5,isExtensible:v5,construct:v5,get:v5,ownKeys:v5,setPrototypeOf:2066857228,has:v5};
    const v55 = new Proxy(v4,v53);
    v55[4142997941] = "MIN_VALUE";
}
const v57 = eval();
}
