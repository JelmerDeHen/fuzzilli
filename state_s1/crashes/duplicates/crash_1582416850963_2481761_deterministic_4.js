function main() {
const v4 = [1000.0,1000.0,1000.0];
const v7 = [1337,1337];
const v8 = [1000.0,"match",Int8Array,1000.0];
const v10 = new Int8Array();
const v11 = v10.slice();
const v12 = {c:v4};
const v13 = {__proto__:v8,e:v12,valueOf:v8,a:v7,constructor:v8,c:v8,d:v12,length:1337};
