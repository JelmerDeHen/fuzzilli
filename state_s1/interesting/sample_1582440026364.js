...
function v10(v11,v12,v13,v14) {
    ...
    // v17 = .object(ofGroup: Uint8Array, withProperties: ["byteLength", "__proto__", "byteOffset", "length", "buffer", "constructor"], withMethods: ["reverse", "copyWithin", "forEach", "filter", "some", "indexOf", "lastIndexOf", "slice", "values", "every", "fill", "subarray", "findIndex", "keys", "reduceRight", "includes", "map", "reduce", "join", "sort", "set", "find", "entries"])
...
// v37 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["set", "has", "ownKeys", "call", "deleteProperty", "getPrototypeOf", "isExtensible", "preventExtensions", "setPrototypeOf", "get", "construct"])
