...
const v7 = {__proto__:Boolean,valueOf:v6,e:v4,d:1337,b:v4};
// v7 = .object(ofGroup: Object, withProperties: ["valueOf", "b", "e", "d", "__proto__"], withMethods: ["__proto__"])
function v8(v9,v10) {
    for (const v12 in "boolean") {
        let v15 = v12;
        const v19 = [13.37,"boolean",-4294967297,13.37];
