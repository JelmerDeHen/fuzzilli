...
function v6(v7,v8) {
    ...
    // v42 = .object(ofGroup: Set, withProperties: ["__proto__", "size"], withMethods: ["clear", "keys", "add", "forEach", "has", "entries", "values", "delete"])
    ...
    // v81 = .object(ofGroup: Object, withProperties: ["length", "d", "__proto__", "constructor", "valueOf"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
