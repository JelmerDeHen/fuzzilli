function main() {
const v4 = {constructor:String,isExtensible:String,preventExtensions:Object};
// v4 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["preventExtensions", "isExtensible", "constructor"])
const v5 = new Int16Array(RegExp,v4);
