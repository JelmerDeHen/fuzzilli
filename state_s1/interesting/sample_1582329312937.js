...
// v5 = .object(ofGroup: Object, withProperties: ["e", "__proto__", "c", "a"])
const v6 = typeof v5;
// v6 = .string
function v9(v10,v11) {
    ...
    do {
        ...
        // v51 = .object(ofGroup: Object, withProperties: ["length", "__proto__", "valueOf", "b"])
        const v52 = [v51];
        // v52 = .object(ofGroup: Array, withProperties: ["constructor", "__proto__", "length"], withMethods: ["forEach", "filter", "unshift", "slice", "splice", "reverse", "reduce", "join", "reduceRight", "some", "pop", "copyWithin", "concat", "flatMap", "shift", "push", "lastIndexOf", "fill", "entries", "sort", "includes", "map", "toString", "values", "indexOf", "keys", "every", "flat", "toLocaleString", "find", "findIndex"])
        const v53 = new WeakMap(v52);
        // v53 = .object(ofGroup: WeakMap, withProperties: ["__proto__"], withMethods: ["has", "set", "delete", "get"])
        v30.__proto__ = v53;
    } while (v21 < 8);
}
const v56 = [1337];
