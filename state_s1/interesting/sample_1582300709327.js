...
// v5 = .object(ofGroup: Object, withProperties: ["toString", "b", "d", "e", "__proto__", "a", "length"])
function v6(v7,v8) {
    for (const v10 in "boolean") {
        ...
        do {
            ...
            // v22 = .object(ofGroup: Map, withProperties: ["__proto__", "size"], withMethods: ["clear", "entries", "forEach", "delete", "has", "keys", "get", "set", "values"])
