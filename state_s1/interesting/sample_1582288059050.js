...
// v3 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["deleteProperty", "preventExtensions", "set", "getPrototypeOf", "apply", "ownKeys", "getOwnPropertyDescriptor", "call", "isExtensible", "defineProperty", "has"])
...
// v12 = .object(ofGroup: Object, withProperties: ["__proto__", "e", "constructor", "a"])
const v13 = {c:13.37,toString:v8,e:v11,constructor:v10,length:v12,a:v10};
// v13 = .object(ofGroup: Object, withProperties: ["toString", "constructor", "e", "a", "c", "length", "__proto__"])
let v14 = v6;
if (v5) {
...
// v29 = .object(ofGroup: Uint32Array, withProperties: ["byteLength", "length", "__proto__", "constructor", "buffer", "byteOffset"], withMethods: ["fill", "sort", "entries", "some", "map", "findIndex", "subarray", "values", "forEach", "filter", "indexOf", "find", "reduce", "keys", "reduceRight", "includes", "copyWithin", "set", "lastIndexOf", "slice", "every", "join", "reverse"])
const v30 = v12[16123];
// v30 = .unknown
