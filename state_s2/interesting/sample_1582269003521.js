...
function v2(v3,v4) {
    for (const v6 in "boolean") {
        ...
        do {
            ...
            // v21 = .object(ofGroup: Object, withProperties: ["byteLength", "__proto__", "length", "constructor", "byteOffset", "b", "buffer"], withMethods: ["some", "shift", "sort", "indexOf", "filter", "every", "subarray", "pop", "includes", "lastIndexOf", "flat", "fill", "entries", "slice", "toLocaleString", "splice", "values", "map", "keys", "unshift", "flatMap", "reverse", "toString", "push", "reduce", "find", "forEach", "concat", "findIndex", "copyWithin", "join", "set", "reduceRight"])
            const v22 = v9 + 1;
            // v22 = .primitive
            v9 = v22;
        } while (v9 < 8);
