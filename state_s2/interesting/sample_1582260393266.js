...
// v18 = .object(ofGroup: Object, withProperties: ["a", "b", "length", "__proto__", "toString"], withMethods: ["__proto__", "valueOf"])
    ...
    for (const v26 in "boolean") {
        ...
        do {
            ...
            try {
                ...
                // v49 = .object(ofGroup: Object, withProperties: ["setPrototypeOf", "get", "construct", "apply", "__proto__"], withMethods: ["set", "deleteProperty"])
