...
// v11 = .object(ofGroup: Int32Array, withProperties: ["__proto__", "length", "byteOffset", "constructor", "buffer", "byteLength"], withMethods: ["forEach", "some", "lastIndexOf", "values", "join", "subarray", "reduce", "reduceRight", "reverse", "sort", "keys", "indexOf", "entries", "slice", "findIndex", "find", "copyWithin", "includes", "map", "filter", "every", "fill", "set"])
}
