...
// v9 = .object(ofGroup: Object, withProperties: ["e", "constructor", "__proto__", "buffer", "byteOffset", "a", "length", "d", "valueOf", "byteLength"], withMethods: ["fill", "subarray", "copyWithin", "sort", "indexOf", "lastIndexOf", "entries", "slice", "some", "join", "filter", "includes", "every", "reduceRight", "keys", "reverse", "forEach", "values", "map", "find", "findIndex", "reduce", "set"])
let v13 = 0;
const v14 = v13 + 1;
// v14 = .primitive
v13 = v14;
