...
// v8 = .object(ofGroup: Object, withProperties: ["__proto__", "c", "toString", "constructor", "d", "a", "valueOf"], withMethods: ["length", "b", "__proto__"])
const v9 = {};
...
function v11(v12,v13) {
    ...
    // v28 = .object(ofGroup: Object, withProperties: ["__proto__", "length", "constructor"], withMethods: ["forEach", "some", "splice", "includes", "reverse", "every", "values", "unshift", "pop", "push", "copyWithin", "reduceRight", "sort", "join", "indexOf", "toLocaleString", "lastIndexOf", "toString", "fill", "reduce", "slice", "keys", "flatMap", "entries", "map", "filter", "find", "findIndex", "flat", "shift", "concat"])
}
