...
for (const v1 in "object") {
    ...
    function v5(v6,v7,v8,v9) {
        ...
        try {
            ...
            const v18 = ["EXkcpBKht7"];
            // v18 = .object(ofGroup: Array, withProperties: ["__proto__", "length", "constructor"], withMethods: ["shift", "findIndex", "reduce", "toString", "flatMap", "unshift", "map", "flat", "fill", "slice", "keys", "some", "splice", "entries", "push", "filter", "toLocaleString", "every", "indexOf", "forEach", "copyWithin", "reverse", "find", "includes", "reduceRight", "values", "join", "concat", "pop", "sort", "lastIndexOf"])
            let v19 = "EXkcpBKht7";
            const v20 = v18.includes(v19,-2695425644);
            // v20 = .boolean
            const v22 = [v9,1337];
            ...
            const v27 = [-372074.99096011615,v22,-372074.99096011615];
            ...
            const v38 = {b:v35,c:v29,valueOf:-9007199254740993,d:v32,constructor:1337,__proto__:v37};
            // v38 = .object(ofGroup: Object, withProperties: ["d", "constructor", "__proto__", "c", "valueOf", "b"])
            let v39 = v38;
            const v41 = [1337];
            // v41 = .object(ofGroup: Array, withProperties: ["__proto__", "length", "constructor"], withMethods: ["shift", "findIndex", "reduce", "toString", "flatMap", "unshift", "map", "flat", "fill", "slice", "keys", "some", "splice", "entries", "push", "filter", "toLocaleString", "every", "indexOf", "forEach", "copyWithin", "reverse", "find", "includes", "reduceRight", "values", "join", "concat", "pop", "sort", "lastIndexOf"])
            const v44 = new Proxy(v39,Object);
            // v44 = .unknown
    ...
    const v46 = {deleteProperty:v5,set:v5,getPrototypeOf:v5,call:v5,preventExtensions:v5,isExtensible:v5,construct:v5,get:v5,ownKeys:v5,setPrototypeOf:1337,has:v5};
    // v46 = .object(ofGroup: Object, withProperties: ["setPrototypeOf", "__proto__"], withMethods: ["preventExtensions", "getPrototypeOf", "set", "has", "deleteProperty", "isExtensible", "construct", "get", "ownKeys", "call"])
    const v48 = new Proxy(v4,v46);
    // v48 = .unknown
    v48[1] = "MIN_VALUE";
}
}
