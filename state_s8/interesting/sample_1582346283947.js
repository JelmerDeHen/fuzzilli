...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v17 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["ownKeys", "setPrototypeOf", "deleteProperty", "isExtensible", "construct", "call", "get", "set", "preventExtensions", "has", "getPrototypeOf"])
