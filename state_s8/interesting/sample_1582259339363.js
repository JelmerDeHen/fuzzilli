...
for (let v3 = 0; v3 < 100; v3++) {
    ...
    // v27 = .object(ofGroup: Object, withProperties: ["e", "__proto__", "constructor", "toString", "d", "length", "c"], withMethods: ["substring", "slice", "repeat", "charCodeAt", "endsWith", "padStart", "replace", "includes", "indexOf", "padEnd", "trim", "charAt", "startsWith", "lastIndexOf", "split", "concat", "codePointAt"])
}
}
