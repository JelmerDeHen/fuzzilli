...
// v18 = .object(ofGroup: Object, withProperties: ["__proto__", "b", "length", "a", "toString"], withMethods: ["__proto__", "valueOf"])
...
function v22(v23,v24) {
    for (const v26 in "boolean") {
        ...
        do {
            ...
            // v39 = .object(ofGroup: Uint16Array, withProperties: ["__proto__", "constructor", "byteOffset", "buffer", "byteLength", "length"], withMethods: ["fill", "reverse", "keys", "forEach", "set", "indexOf", "subarray", "lastIndexOf", "sort", "reduce", "findIndex", "map", "every", "entries", "join", "find", "some", "slice", "values", "includes", "filter", "reduceRight", "copyWithin"])
            ...
            try {
                ...
                // v49 = .object(ofGroup: Object, withProperties: ["apply", "get", "setPrototypeOf", "construct", "__proto__"], withMethods: ["set", "deleteProperty"])
