...
function v6(v7,v8,v9,v10) {
    ...
    try {
        ...
        // v15 = .object(ofGroup: Float32Array, withProperties: ["__proto__", "buffer", "constructor", "length", "byteLength", "byteOffset"], withMethods: ["sort", "some", "indexOf", "find", "subarray", "set", "reverse", "reduce", "join", "values", "keys", "entries", "map", "copyWithin", "includes", "findIndex", "slice", "reduceRight", "lastIndexOf", "filter", "every", "fill", "forEach"])
        v10[3] = v10;
    } catch(v16) {
...
// v25 = .object(ofGroup: Object, withProperties: ["get", "__proto__"], withMethods: ["ownKeys", "has", "deleteProperty", "construct", "getPrototypeOf", "preventExtensions", "set", "setPrototypeOf", "call", "isExtensible"])
