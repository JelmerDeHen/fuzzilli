...
function v2(v3,v4) {
    ...
    function v8(v9,v10) {
        for (const v12 in "boolean") {
            ...
            // v21 = .object(ofGroup: Object, withProperties: ["a", "__proto__", "valueOf"], withMethods: ["e"])
            function v23(v24,v25,v26,v27,...v28) {
                const v30 = [1337];
                // v30 = .object(ofGroup: Array, withProperties: ["__proto__", "length", "constructor"], withMethods: ["shift", "findIndex", "reduce", "toString", "flatMap", "unshift", "map", "flat", "fill", "slice", "keys", "some", "splice", "entries", "push", "filter", "toLocaleString", "every", "indexOf", "forEach", "copyWithin", "reverse", "find", "includes", "reduceRight", "values", "join", "concat", "pop", "sort", "lastIndexOf"])
                let v31 = v30;
                const v32 = {b:1337,e:v31,length:v21,__proto__:v23,d:v26,...v23};
                // v32 = .object(ofGroup: Object, withProperties: ["__proto__", "b", "d", "length", "e"], withMethods: ["__proto__"])
            }
            const v33 = v23(1337);
            // v33 = .unknown
        }
