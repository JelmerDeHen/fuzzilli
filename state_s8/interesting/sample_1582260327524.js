...
// v6 = .object(ofGroup: Object, withProperties: ["e", "length", "d", "c", "__proto__"])
function v7(v8,v9) {
    const v12 = {ownKeys:v9,preventExtensions:v9,defineProperty:v7,getPrototypeOf:v9,deleteProperty:v9,has:v7,set:v8,apply:v9};
    // v12 = .object(ofGroup: Object, withProperties: ["getPrototypeOf", "deleteProperty", "set", "apply", "ownKeys", "__proto__", "preventExtensions"], withMethods: ["has", "defineProperty"])
