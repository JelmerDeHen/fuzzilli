...
// v6 = .object(ofGroup: Object, withProperties: ["__proto__", "valueOf", "toString", "constructor"])
let v7 = v6;
function v9(v10,v11) {
    for (const v13 in "boolean") {
        ...
        // v25 = .object(ofGroup: Object, withProperties: ["has", "isExtensible", "setPrototypeOf", "set", "construct", "deleteProperty", "defineProperty", "__proto__", "apply", "getPrototypeOf"], withMethods: ["ownKeys", "get", "getOwnPropertyDescriptor", "call"])
        ...
        for (const v33 in v25) {
            ...
            // v34 = .object(ofGroup: Object, withProperties: ["has", "preventExtensions", "apply", "__proto__"], withMethods: ["get", "setPrototypeOf", "getPrototypeOf"])
        }
    }
}
