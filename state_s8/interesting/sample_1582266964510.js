...
function v6(v7,v8) {
    ...
    const v42 = new Set(v41);
    // v42 = .object(ofGroup: Set, withProperties: ["__proto__", "size"], withMethods: ["delete", "clear", "keys", "add", "forEach", "values", "entries", "has"])
    ...
    const v80 = 3156875969 in DataView;
    // v80 = .boolean
    const v81 = {__proto__:3,constructor:v76,d:v71,valueOf:v73,length:13.37};
    // v81 = .object(ofGroup: Object, withProperties: ["length", "constructor", "valueOf", "d", "__proto__"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
