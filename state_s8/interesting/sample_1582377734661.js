...
function v1(v2,v3) {
    for (const v5 in "boolean") {
        ...
        do {
            ...
            // v15 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["apply", "ownKeys", "set", "construct", "getOwnPropertyDescriptor", "getPrototypeOf", "get", "isExtensible", "preventExtensions", "deleteProperty", "defineProperty"])
