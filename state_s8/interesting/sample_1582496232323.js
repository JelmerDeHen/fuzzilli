...
try {
    ...
    function v16(v17,v18) {
        ...
        try {
            ...
            // v28 = .object(ofGroup: Object, withProperties: ["length", "byteLength", "__proto__", "byteOffset", "buffer", "constructor"], withMethods: ["filter", "entries", "values", "reduce", "set", "find", "copyWithin", "join", "map", "keys", "subarray", "forEach", "some", "fill", "reduceRight", "lastIndexOf", "sort", "slice", "reverse", "indexOf", "findIndex", "includes", "a", "every"])
        }
    }
