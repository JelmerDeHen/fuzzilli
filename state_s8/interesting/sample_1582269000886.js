...
function v2(v3,v4) {
    for (const v6 in "boolean") {
        ...
        do {
            ...
            // v21 = .object(ofGroup: Object, withProperties: ["length", "constructor", "__proto__", "byteOffset", "b", "byteLength", "buffer"], withMethods: ["findIndex", "unshift", "pop", "toLocaleString", "copyWithin", "flat", "entries", "reduceRight", "join", "toString", "map", "keys", "slice", "reverse", "lastIndexOf", "push", "values", "filter", "splice", "subarray", "includes", "indexOf", "every", "sort", "some", "forEach", "flatMap", "reduce", "fill", "set", "concat", "shift", "find"])
            const v22 = v9 + 1;
            // v22 = .primitive
            v9 = v22;
        } while (v9 < 8);
