...
function v3(v4,v5,v6,v7) {
    ...
    try {
        ...
        // v11 = .object(ofGroup: Int16Array, withProperties: ["__proto__", "length", "constructor", "byteOffset", "byteLength", "buffer"], withMethods: ["find", "join", "fill", "entries", "subarray", "reduceRight", "map", "reverse", "set", "sort", "reduce", "keys", "indexOf", "copyWithin", "forEach", "slice", "lastIndexOf", "values", "every", "includes", "filter", "findIndex", "some"])
        const v13 = [1337];
...
// v17 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["call", "preventExtensions", "isExtensible", "construct", "ownKeys", "set", "get", "has", "deleteProperty", "setPrototypeOf", "getPrototypeOf"])
