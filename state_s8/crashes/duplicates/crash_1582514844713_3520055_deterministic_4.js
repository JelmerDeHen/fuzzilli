...
const v9 = {deleteProperty:v4,set:v4,getPrototypeOf:v4,call:Infinity,preventExtensions:v4,isExtensible:v4,construct:v4,get:v4,ownKeys:v4,setPrototypeOf:v4,has:v4};
const v11 = new Proxy(v3,v9);
const v14 = [13.37,13.37,13.37,13.37,13.37];
const v16 = [1337,1337,1337,1337];
const v17 = ["buffer",v14];
const v18 = {d:1337,length:v17};
const v19 = {length:undefined,__proto__:1337,toString:v16,a:undefined,d:undefined};
let v20 = 13.37;
