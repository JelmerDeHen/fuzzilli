...
// v5 = .object(ofGroup: Object, withProperties: ["a", "constructor", "d", "e", "__proto__", "length"])
const v6 = {__proto__:v3,toString:"eTm8XK*Max",e:v5,b:v4,a:v4,constructor:13.37};
// v6 = .object(ofGroup: Object, withProperties: ["toString", "constructor", "e", "__proto__", "b", "a"])
function v7(v8,v9) {
    for (const v10 in v6) {
