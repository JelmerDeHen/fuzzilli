...
function v6(v7,v8) {
    ...
    // v42 = .object(ofGroup: Set, withProperties: ["size", "__proto__"], withMethods: ["add", "clear", "delete", "entries", "has", "forEach", "keys", "values"])
    ...
    // v81 = .object(ofGroup: Object, withProperties: ["d", "length", "__proto__", "constructor", "valueOf"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
