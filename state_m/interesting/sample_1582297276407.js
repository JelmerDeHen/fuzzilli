...
function v8(v9,v10) {
    for (const v12 in "boolean") {
        ...
        // v23 = .object(ofGroup: Object, withProperties: ["get", "ownKeys", "defineProperty", "construct", "preventExtensions", "__proto__", "isExtensible"], withMethods: ["setPrototypeOf", "set", "has"])
    }
}
