...
// v9 = .object(ofGroup: Object, withProperties: ["__proto__", "toString", "a", "length", "e"], withMethods: ["d"])
let v10 = "unscopable";
...
// v53 = .object(ofGroup: Object, withProperties: ["a", "valueOf", "length", "__proto__", "e", "b"])
let v56 = undefined;
const v59 = new Int32Array(16675);
// v59 = .object(ofGroup: Int32Array, withProperties: ["buffer", "length", "byteLength", "__proto__", "byteOffset", "constructor"], withMethods: ["indexOf", "some", "lastIndexOf", "reduceRight", "findIndex", "copyWithin", "forEach", "set", "fill", "filter", "join", "values", "reverse", "map", "subarray", "keys", "slice", "includes", "find", "entries", "sort", "every", "reduce"])
...
for (const v65 in "object") {
    ...
    // v66 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["has", "getPrototypeOf", "isExtensible", "preventExtensions", "getOwnPropertyDescriptor", "setPrototypeOf", "deleteProperty", "construct", "toString", "apply"])
    ...
    // v69 = .object(ofGroup: Object, withProperties: ["isExtensible", "deleteProperty", "construct", "__proto__"], withMethods: ["preventExtensions", "apply", "a"])
    v68[v69] = Uint16Array;
}
v29 = v39;
