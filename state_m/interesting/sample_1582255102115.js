...
// v6 = .object(ofGroup: Object, withProperties: ["b", "valueOf", "constructor", "__proto__", "a"])
let v7 = Uint8Array;
let v10 = 0;
do {
    const v11 = v10 + 1;
        ...
        for (let v25 = 0; v25 < 10; v25++) {
            ...
            if (v14) {
                ...
                for (const v30 in "undefined") {
                    ...
                    // v31 = .object(ofGroup: Uint8Array, withProperties: ["length", "byteOffset", "buffer", "__proto__", "constructor", "byteLength"], withMethods: ["keys", "findIndex", "filter", "indexOf", "reduceRight", "sort", "map", "some", "subarray", "reduce", "fill", "lastIndexOf", "set", "values", "entries", "reverse", "every", "includes", "join", "slice", "copyWithin", "forEach", "find"])
                }
            }
        }
        let v34 = 0;
