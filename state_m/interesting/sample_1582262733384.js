...
// v8 = .object(ofGroup: Object, withProperties: ["__proto__", "d", "valueOf", "c", "toString", "constructor", "a"], withMethods: ["__proto__", "length", "b"])
const v9 = {};
...
function v11(v12,v13) {
    ...
    // v28 = .object(ofGroup: Object, withProperties: ["__proto__", "constructor", "length"], withMethods: ["unshift", "join", "forEach", "toLocaleString", "lastIndexOf", "slice", "flatMap", "reverse", "fill", "find", "push", "keys", "values", "every", "filter", "flat", "pop", "shift", "reduce", "sort", "concat", "some", "includes", "indexOf", "map", "splice", "copyWithin", "reduceRight", "entries", "toString", "findIndex"])
}
