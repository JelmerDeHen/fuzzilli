...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v30 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["ownKeys", "has", "construct", "deleteProperty", "isExtensible", "setPrototypeOf", "get", "getPrototypeOf", "set", "call", "preventExtensions"])
