...
function v0(v1,v2) {
    for (const v4 in "boolean") {
        ...
        do {
            ...
            // v18 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["ownKeys", "get", "preventExtensions", "apply", "construct", "isExtensible", "getOwnPropertyDescriptor", "getPrototypeOf", "deleteProperty", "set", "defineProperty"])
