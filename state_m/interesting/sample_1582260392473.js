...
// v18 = .object(ofGroup: Object, withProperties: ["a", "__proto__", "b", "toString", "length"], withMethods: ["__proto__", "valueOf"])
...
function v22(v23,v24) {
    for (const v26 in "boolean") {
        ...
        do {
            ...
            // v39 = .object(ofGroup: Uint16Array, withProperties: ["byteLength", "__proto__", "length", "buffer", "constructor", "byteOffset"], withMethods: ["findIndex", "sort", "set", "entries", "lastIndexOf", "filter", "slice", "map", "forEach", "values", "indexOf", "reduceRight", "keys", "find", "subarray", "join", "reverse", "includes", "every", "some", "reduce", "copyWithin", "fill"])
            ...
            try {
                ...
                // v49 = .object(ofGroup: Object, withProperties: ["setPrototypeOf", "apply", "__proto__", "construct", "get"], withMethods: ["set", "deleteProperty"])
                const v51 = Proxy(v46,v49);
                // v51 = .unknown
                const v52 = {defineProperty:v35,has:v24};
                // v52 = .object(ofGroup: Object, withProperties: ["defineProperty", "has", "__proto__"])
