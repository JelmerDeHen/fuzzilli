...
// v3 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["ownKeys", "isExtensible", "has", "getPrototypeOf", "set", "defineProperty", "getOwnPropertyDescriptor", "preventExtensions", "deleteProperty", "apply", "call"])
...
// v13 = .object(ofGroup: Object, withProperties: ["__proto__", "constructor", "a", "toString", "length", "c", "e"])
let v14 = v6;
if (v5) {
...
// v29 = .object(ofGroup: Uint32Array, withProperties: ["buffer", "length", "__proto__", "byteLength", "byteOffset", "constructor"], withMethods: ["includes", "forEach", "every", "some", "subarray", "lastIndexOf", "values", "copyWithin", "findIndex", "reverse", "sort", "keys", "filter", "join", "indexOf", "reduce", "reduceRight", "set", "slice", "find", "fill", "map", "entries"])
const v30 = v12[16123];
// v30 = .unknown
