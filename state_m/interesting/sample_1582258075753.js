...
for (let v4 = 0; v4 < 100; v4++) {
    ...
    // v25 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["apply", "defineProperty", "has", "getOwnPropertyDescriptor", "isExtensible", "setPrototypeOf", "deleteProperty", "construct", "set", "ownKeys", "preventExtensions"])
