...
const v6 = [1337];
const v7 = [v4,13.37,1337,"object"];
const v8 = {a:13.37,__proto__:Map,length:-4294967296,b:13.37};
...
const v79 = [1024,1024,1024,1024];
const v80 = {b:v79,e:13.37,constructor:v77,__proto__:v79};
const v82 = [13.37,13.37,13.37,13.37];
function v83(v84,v85) {
}
const v86 = v82.sort(v83);
}
