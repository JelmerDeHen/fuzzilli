...
const v74 = 13.37 + "P/u36zOlAO";
const v76 = new Int16Array();
try {
    const v79 = [13.37,13.37];
    const v80 = v79[1024];
    const v81 = {has:Array,construct:v80,toString:v80,deleteProperty:Array,setPrototypeOf:Array,preventExtensions:v80,isExtensible:v80,call:v80,set:Array,getOwnPropertyDescriptor:Array};
    const v83 = Proxy();
} catch(v84) {
}
