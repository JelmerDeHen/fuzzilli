...
const v7 = [13.37,"nKeuIDBhhz",String,String];
const v8 = {toString:String,__proto__:-4294967297,e:String,constructor:String};
const v9 = {valueOf:v6,toString:-4294967297,__proto__:v4,e:-4294967297,a:13.37};
let v10 = v8;
    ...
    try {
        ...
        function v34(v35,v36) {
            for (const v38 in "ruHq55V2**") {
                ...
                const v75 = [13.37,13.37,13.37,13.37,WeakSet];
                const v77 = new Uint8ClampedArray();
                const v80 = v77.slice(-42667988,2117265137);
                const v81 = new Proxy(v42,v71);
                v81[1] = "MIN_VALUE";
            }
            return v22;
        }
