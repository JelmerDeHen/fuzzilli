function main() {
const v3 = [13.37,13.37,-256,13.37];
const v5 = [1337];
const v6 = [13.37];
const v7 = {length:JSON,b:JSON,toString:13.37,a:JSON,c:v3,constructor:v3};
const v8 = {length:v6,valueOf:v7,toString:v5,__proto__:v5,a:-256};
let v9 = -256;
const v12 = [13.37];
...
const v20 = {b:v19};
const v21 = new Promise(v13,v20,"undefined",v12);
