...
const v6 = [1337,1337];
const v7 = [13.37,"match",Int8Array,13.37];
const v8 = {c:v4};
const v9 = {__proto__:v7,e:v8,valueOf:v7,a:v6,constructor:v7,c:v7,d:v8,length:1337};
...
v75[1] = "MIN_VALUE";
const v76 = [v10,v21,...1337,...Int8Array];
const v77 = "match".trim();
}
