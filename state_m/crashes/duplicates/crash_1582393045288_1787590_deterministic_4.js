...
const v6 = ["a"];
const v7 = {get:String,ownKeys:String,construct:String,preventExtensions:String,set:String,call:String,has:String,setPrototypeOf:String,isExtensible:String,defineProperty:String};
const v9 = new Proxy(v6,v7);
const v10 = {__proto__:v6,valueOf:v5};
const v11 = {length:"a",__proto__:String,b:v3,a:v6,e:1337,toString:v5};
let v12 = v5;
