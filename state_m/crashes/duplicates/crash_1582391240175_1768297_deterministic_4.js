...
try {
    const v7 = [];
    const v9 = [v7,-1882595336,-1882595336,-1882595336,-1882595336];
    const v13 = Reflect.construct(WeakSet,Uint32Array);
    const v14 = v13 >= v9;
} catch(v15) {
}
const v16 = [1337,Uint8Array,3735314314,v6];
const v17 = {length:v16};
const v18 = {valueOf:"a8mixRFCFj"};
let v19 = 3735314314;
