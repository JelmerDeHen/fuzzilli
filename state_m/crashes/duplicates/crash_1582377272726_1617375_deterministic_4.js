...
for (const v1 in "object") {
    ...
    const v53 = {deleteProperty:v5,set:v5,getPrototypeOf:v5,call:v5,preventExtensions:v5,isExtensible:v5,construct:v5,get:v5,a:v5,setPrototypeOf:1337,has:v5};
