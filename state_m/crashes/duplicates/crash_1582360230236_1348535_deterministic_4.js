...
for (const v1 in "object") {
    ...
    const v33 = {deleteProperty:v5,set:v5,getPrototypeOf:v5,call:v5,preventExtensions:v4,isExtensible:v5,construct:v5,get:v5,ownKeys:v5,setPrototypeOf:v5,has:v5};
