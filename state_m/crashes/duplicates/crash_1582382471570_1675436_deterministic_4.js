function main() {
let v4 = 3;
const v5 = "valueOf".concat(Proxy,3);
const v6 = (13.37)[v5];
const v7 = [13.37,13.37,13.37,13.37,13.37];
const v9 = [1337,1337];
const v10 = [];
const v11 = {toString:"valueOf",__proto__:"valueOf"};
const v12 = {c:"valueOf",valueOf:Proxy,length:3,d:v10,constructor:13.37,a:v11,e:"valueOf"};
let v13 = 1337;
