function main() {
const v3 = [];
const v4 = {__proto__:9007199254740991,length:1337,constructor:1337,a:v3};
const v6 = new Uint8Array();
const v9 = [13.37,13.37,13.37];
const v11 = [1337,1337,1337];
const v12 = [];
const v13 = {constructor:1337};
const v14 = {__proto__:v13,d:1337,valueOf:v11,b:"undefined",toString:4294967296};
let v15 = v11;
try {
    const v17 = true();
} catch(v18) {
