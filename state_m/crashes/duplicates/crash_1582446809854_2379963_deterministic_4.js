...
const v7 = [13.37,127,"boolean"];
const v8 = {valueOf:v7,__proto__:127,c:Promise};
const v9 = v6.fill();
const v10 = new Promise(Promise,1337,127,v6);
const v11 = {a:Promise,toString:v4,c:1337,b:127,valueOf:v7};
let v12 = 1337;
const v14 = new Int32Array();
const v17 = [13.37,-65536,13.37];
