...
const v7 = [1337,1337,128,128];
const v8 = {constructor:v7,length:parseFloat};
const v9 = {c:v8,length:v8,toString:parseFloat,__proto__:v6,a:v8,constructor:13.37,valueOf:128};
let v10 = v7;
let v12 = 0;
const v13 = "boolean" != v9;
