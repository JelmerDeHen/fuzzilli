...
const v7 = Symbol.replace;
const v9 = Symbol.split;
const v10 = Symbol[v9];
for (let v14 = 0; v14 < 6; v14++) {
    const v15 = "number".trim();
}
const v17 = {get:Symbol};
const v19 = Object.defineProperty(v4,"a",v17);
const v20 = [1337,1337,1337];
const v21 = [];
const v22 = {constructor:"number",toString:v4,__proto__:13.37,valueOf:"number",c:v20,length:parseFloat};
const v23 = {valueOf:-1196352494,c:v4,length:13.37,d:v4};
let v24 = v22;
