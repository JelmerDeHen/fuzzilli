...
const v7 = [256,Infinity];
const v8 = {a:v6,d:v6,length:256,valueOf:v6};
const v9 = {length:1337,e:v8,constructor:Infinity,valueOf:v4,a:"size",__proto__:Infinity,b:Infinity};
let v10 = 256;
