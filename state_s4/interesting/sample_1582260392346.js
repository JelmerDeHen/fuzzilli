...
// v18 = .object(ofGroup: Object, withProperties: ["toString", "length", "a", "b", "__proto__"], withMethods: ["valueOf", "__proto__"])
...
function v22(v23,v24) {
    for (const v26 in "boolean") {
        ...
        do {
            ...
            // v39 = .object(ofGroup: Uint16Array, withProperties: ["length", "byteLength", "__proto__", "buffer", "constructor", "byteOffset"], withMethods: ["fill", "findIndex", "filter", "entries", "map", "find", "sort", "every", "reduce", "join", "set", "copyWithin", "subarray", "reverse", "some", "indexOf", "includes", "reduceRight", "lastIndexOf", "values", "slice", "keys", "forEach"])
            ...
            try {
                ...
                // v49 = .object(ofGroup: Object, withProperties: ["construct", "apply", "setPrototypeOf", "get", "__proto__"], withMethods: ["deleteProperty", "set"])
