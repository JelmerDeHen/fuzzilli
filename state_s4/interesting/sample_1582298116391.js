...
function v6(v7,v8,v9,v10) {
    ...
    try {
        ...
        // v15 = .object(ofGroup: Float32Array, withProperties: ["byteOffset", "byteLength", "length", "constructor", "buffer", "__proto__"], withMethods: ["slice", "entries", "some", "set", "indexOf", "join", "includes", "map", "lastIndexOf", "keys", "forEach", "reduce", "fill", "findIndex", "reduceRight", "find", "subarray", "copyWithin", "reverse", "sort", "filter", "every", "values"])
        v10[3] = v10;
    } catch(v16) {
...
// v25 = .object(ofGroup: Object, withProperties: ["__proto__", "get"], withMethods: ["preventExtensions", "construct", "setPrototypeOf", "deleteProperty", "has", "isExtensible", "ownKeys", "set", "call", "getPrototypeOf"])
