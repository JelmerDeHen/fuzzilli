...
function v6(v7,v8) {
    ...
    // v42 = .object(ofGroup: Set, withProperties: ["__proto__", "size"], withMethods: ["clear", "keys", "delete", "values", "has", "forEach", "add", "entries"])
    ...
    // v81 = .object(ofGroup: Object, withProperties: ["d", "valueOf", "__proto__", "length", "constructor"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
