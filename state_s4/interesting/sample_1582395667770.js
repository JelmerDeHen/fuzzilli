...
for (const v2 in "object") {
    for (const v4 in "boolean") {
        ...
        // v11 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["preventExtensions", "deleteProperty", "construct", "getPrototypeOf", "get", "ownKeys", "has", "call", "set", "setPrototypeOf", "isExtensible"])
