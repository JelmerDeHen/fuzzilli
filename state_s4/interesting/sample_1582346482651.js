...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v17 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["isExtensible", "getPrototypeOf", "set", "has", "deleteProperty", "setPrototypeOf", "preventExtensions", "get", "construct", "call", "ownKeys"])
