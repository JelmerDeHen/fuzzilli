...
const v7 = ["NaN",2147483649,Uint16Array];
// v7 = .object(ofGroup: Array, withProperties: ["length", "__proto__", "constructor"], withMethods: ["copyWithin", "reduceRight", "concat", "every", "some", "toString", "filter", "toLocaleString", "slice", "map", "join", "values", "sort", "indexOf", "keys", "splice", "fill", "includes", "pop", "reduce", "lastIndexOf", "find", "flatMap", "findIndex", "unshift", "flat", "reverse", "shift", "entries", "forEach", "push"])
const v8 = {c:Uint16Array,d:v6,a:v6,toString:2147483649,__proto__:v4,constructor:1337};
// v8 = .object(ofGroup: Object, withProperties: ["toString", "d", "constructor", "__proto__", "c", "a"])
const v9 = {__proto__:v4,b:1337,d:v4,length:v6,c:v4,valueOf:Uint16Array};
// v9 = .object(ofGroup: Object, withProperties: ["d", "valueOf", "b", "__proto__", "c", "length"])
let v10 = 13.37;
const v15 = JSON.stringify(0);
...
const v21 = v20.padStart(1337,v15);
