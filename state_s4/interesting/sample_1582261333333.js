...
for (const v3 in "boolean") {
    for (const v5 in "object") {
        function v6(v7,v8) {
            ...
            // v10 = .object(ofGroup: Object, withProperties: ["deleteProperty", "set", "__proto__", "preventExtensions", "apply", "getPrototypeOf", "ownKeys"], withMethods: ["has", "defineProperty"])
            const v12 = new Proxy(v6,v10);
            // v12 = .unknown
            const v13 = {toString:0,...Proxy,...v6,...v12};
            // v13 = .object(ofGroup: Object, withProperties: ["toString", "__proto__"])
        }
        const v14 = v6();
        // v14 = .unknown
    }
