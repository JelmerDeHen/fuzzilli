...
// v15 = .object(ofGroup: Int32Array, withProperties: ["buffer", "byteLength", "byteOffset", "length", "__proto__", "constructor"], withMethods: ["find", "forEach", "entries", "subarray", "reduce", "fill", "set", "lastIndexOf", "every", "slice", "findIndex", "some", "join", "reverse", "indexOf", "keys", "filter", "copyWithin", "sort", "reduceRight", "map", "includes", "values"])
}
