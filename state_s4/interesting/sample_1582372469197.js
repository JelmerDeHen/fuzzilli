...
function v6(v7,v8) {
    for (const v10 in "boolean") {
        ...
        do {
            ...
            // v29 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["deleteProperty", "getPrototypeOf", "isExtensible", "defineProperty", "preventExtensions", "construct", "ownKeys", "apply", "getOwnPropertyDescriptor", "set", "get"])
