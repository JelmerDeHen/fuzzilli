...
for (const v2 in "object") {
    ...
    function v6(v7,v8,v9,v10) {
        ...
        try {
            ...
            const v17 = Math.hypot(-1970853828,13.37,"boolean",DataView);
            // v17 = .number
            const v21 = [v6];
            ...
            // v24 = .object(ofGroup: Object, withProperties: ["a", "c", "constructor", "valueOf", "__proto__", "toString"])
        }
        return v5;
    }
    ...
    // v25 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["setPrototypeOf", "deleteProperty", "isExtensible", "preventExtensions", "call", "construct", "has", "get", "set", "ownKeys", "getPrototypeOf"])
