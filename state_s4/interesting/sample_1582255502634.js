...
function v3(v4,v5) {
    ...
    // v13 = .object(ofGroup: Object, withProperties: ["a", "e", "__proto__", "constructor", "c", "d"])
    ...
    // v33 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["apply", "preventExtensions", "has", "defineProperty", "construct", "isExtensible", "set", "setPrototypeOf", "deleteProperty", "getOwnPropertyDescriptor", "ownKeys"])
    const v35 = new Proxy(v21,v33);
    // v35 = .unknown
    const v36 = v35[4088076774];
    // v36 = .unknown
    const v37 = {e:DataView,constructor:1337,valueOf:1337,d:v12};
    // v37 = .object(ofGroup: Object, withProperties: ["d", "__proto__", "constructor", "e", "valueOf"])
    let v43 = 0;
    const v44 = v43 + 1;
    // v44 = .primitive
