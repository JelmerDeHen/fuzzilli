...
const v5 = [59446.68221467873];
// v5 = .object(ofGroup: Array, withProperties: ["length", "__proto__", "constructor"], withMethods: ["copyWithin", "reduceRight", "concat", "every", "some", "toString", "filter", "toLocaleString", "slice", "map", "join", "values", "sort", "indexOf", "keys", "splice", "fill", "includes", "pop", "reduce", "lastIndexOf", "find", "flatMap", "findIndex", "unshift", "flat", "reverse", "shift", "entries", "forEach", "push"])
const v7 = [v5,1337,3779702335];
...
function v8(v9,v10) {
    ...
    // v20 = .object(ofGroup: Object, withProperties: ["constructor", "toString", "length", "e", "c", "__proto__", "b"])
    let v21 = 1337;
    const v23 = {__proto__:536870912};
    ...
    // v30 = .boolean
    let v32 = 9007199254740993;
    let v33 = 13.37;
    try {
        let v34 = eval;
        v33 = v34;
    } catch(v35) {
        const v38 = Float32Array(4715);
        // v38 = .unknown
    }
    ...
    for (const v52 in "KAg0f52tJR") {
        v1.__proto__ = v15;
    }
    const v53 = Math.fround(v9);
    // v53 = .number
    const v55 = v53 === 0;
    // v55 = .boolean
