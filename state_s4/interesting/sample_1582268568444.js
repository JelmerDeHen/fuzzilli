...
function v6(v7,v8) {
    ...
    // v41 = .object(ofGroup: Set, withProperties: ["__proto__", "size"], withMethods: ["clear", "keys", "delete", "values", "has", "forEach", "add", "entries"])
    const v42 = v41.has();
    // v42 = .boolean
    const v43 = {};
    ...
    // v80 = .object(ofGroup: Object, withProperties: ["length", "__proto__", "constructor", "d", "valueOf"])
    const v82 = Object();
    // v82 = .object()
    try {
    } catch(v83) {
