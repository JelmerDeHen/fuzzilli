...
// v6 = .object(ofGroup: Object, withProperties: ["toString", "__proto__", "constructor", "valueOf"])
let v7 = v6;
function v9(v10,v11) {
    for (const v13 in "boolean") {
        ...
        // v25 = .object(ofGroup: Object, withProperties: ["apply", "getPrototypeOf", "isExtensible", "has", "setPrototypeOf", "deleteProperty", "construct", "set", "__proto__", "defineProperty"], withMethods: ["getOwnPropertyDescriptor", "get", "call", "ownKeys"])
        ...
        for (const v33 in v25) {
            ...
            // v34 = .object(ofGroup: Object, withProperties: ["preventExtensions", "apply", "__proto__", "has"], withMethods: ["getPrototypeOf", "setPrototypeOf", "get"])
        }
    }
}
