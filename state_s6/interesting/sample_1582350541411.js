...
function v2(v3,v4) {
    ...
    while (v7 < 5) {
        ...
        // v9 = .number
        const v13 = {e:1.0,b:"d"};
        // v13 = .object(ofGroup: Object, withProperties: ["__proto__", "b", "e"])
        let v17 = -128;
        while (v17 < 5) {
            const v18 = v13 === 0;
            // v18 = .boolean
        ...
        // v30 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["setPrototypeOf", "has", "get", "preventExtensions", "set", "getPrototypeOf", "construct", "deleteProperty", "isExtensible", "call", "ownKeys"])
