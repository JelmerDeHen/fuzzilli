...
// v3 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["apply", "ownKeys", "getPrototypeOf", "defineProperty", "preventExtensions", "deleteProperty", "isExtensible", "set", "getOwnPropertyDescriptor", "has", "call"])
...
// v12 = .object(ofGroup: Object, withProperties: ["__proto__", "constructor", "e", "a"])
const v13 = {c:13.37,toString:v8,e:v11,constructor:v10,length:v12,a:v10};
// v13 = .object(ofGroup: Object, withProperties: ["e", "toString", "length", "c", "constructor", "a", "__proto__"])
let v14 = v6;
if (v5) {
...
// v29 = .object(ofGroup: Uint32Array, withProperties: ["buffer", "byteOffset", "__proto__", "constructor", "byteLength", "length"], withMethods: ["entries", "keys", "map", "every", "set", "reduce", "includes", "reduceRight", "lastIndexOf", "some", "findIndex", "find", "subarray", "filter", "join", "values", "reverse", "copyWithin", "indexOf", "forEach", "sort", "fill", "slice"])
const v30 = v12[16123];
// v30 = .unknown
