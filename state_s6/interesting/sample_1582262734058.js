...
// v8 = .object(ofGroup: Object, withProperties: ["constructor", "d", "c", "toString", "a", "__proto__", "valueOf"], withMethods: ["b", "__proto__", "length"])
const v9 = {};
...
function v11(v12,v13) {
    ...
    // v28 = .object(ofGroup: Object, withProperties: ["constructor", "length", "__proto__"], withMethods: ["includes", "values", "pop", "keys", "flat", "toString", "push", "join", "map", "filter", "reduceRight", "some", "entries", "shift", "lastIndexOf", "sort", "concat", "reverse", "unshift", "flatMap", "toLocaleString", "find", "indexOf", "copyWithin", "every", "findIndex", "reduce", "forEach", "splice", "fill", "slice"])
}
