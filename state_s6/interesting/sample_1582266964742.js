...
function v6(v7,v8) {
    ...
    // v42 = .object(ofGroup: Set, withProperties: ["__proto__", "size"], withMethods: ["delete", "add", "forEach", "has", "clear", "keys", "values", "entries"])
    ...
    // v81 = .object(ofGroup: Object, withProperties: ["constructor", "length", "valueOf", "d", "__proto__"])
    const v83 = Object();
    // v83 = .object()
    try {
    } catch(v84) {
