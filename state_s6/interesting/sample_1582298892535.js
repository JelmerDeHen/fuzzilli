...
function v3(v4,v5,v6,v7) {
    ...
    try {
        ...
        // v11 = .object(ofGroup: Int16Array, withProperties: ["__proto__", "constructor", "buffer", "length", "byteLength", "byteOffset"], withMethods: ["fill", "subarray", "findIndex", "some", "lastIndexOf", "sort", "reduceRight", "includes", "slice", "copyWithin", "entries", "reduce", "reverse", "map", "join", "values", "set", "keys", "forEach", "indexOf", "find", "filter", "every"])
        const v13 = [1337];
...
// v17 = .object(ofGroup: Object, withProperties: ["__proto__"], withMethods: ["isExtensible", "construct", "getPrototypeOf", "has", "deleteProperty", "setPrototypeOf", "ownKeys", "call", "set", "get", "preventExtensions"])
