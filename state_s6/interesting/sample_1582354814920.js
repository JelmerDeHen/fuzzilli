...
// v12 = .object(ofGroup: Float64Array, withProperties: ["constructor", "length", "byteOffset", "byteLength", "buffer", "__proto__"], withMethods: ["set", "reduceRight", "some", "join", "subarray", "filter", "every", "values", "fill", "indexOf", "findIndex", "sort", "reverse", "forEach", "find", "includes", "map", "lastIndexOf", "reduce", "copyWithin", "keys", "entries", "slice"])
}
