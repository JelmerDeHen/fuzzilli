...
function v2(v3,v4) {
    ...
    for (const v29 in "boolean") {
        ...
        do {
            ...
            // v48 = .object(ofGroup: Object, withProperties: ["__proto__", "a", "constructor", "length"], withMethods: ["toString"])
            let v50 = 0;
            const v51 = v50 + 1;
            // v51 = .primitive
            v50 = v51;
            ...
            // v53 = .object(ofGroup: Object, withProperties: ["length", "constructor", "__proto__", "a"], withMethods: ["toString"])
