...
function v9(v10,v11) {
    for (const v13 in "boolean") {
        ...
        // v25 = .object(ofGroup: Object, withProperties: ["__proto__", "has", "set", "defineProperty", "isExtensible", "setPrototypeOf", "apply", "deleteProperty", "getPrototypeOf", "construct"], withMethods: ["getOwnPropertyDescriptor", "get", "ownKeys", "call"])
        ...
        for (const v33 in v25) {
            ...
            // v34 = .object(ofGroup: Object, withProperties: ["apply", "__proto__", "preventExtensions", "has"], withMethods: ["setPrototypeOf", "get", "getPrototypeOf"])
        }
    }
}
