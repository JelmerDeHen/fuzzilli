function main() {
const v2 = [13.37,13.37,"as8PYwhNKV",13.37,13.37];
const v4 = [13.37,1337,1337];
const v5 = [v2,13.37,13.37,13.37];
const v6 = {valueOf:"as8PYwhNKV",c:v4,e:v4,length:"as8PYwhNKV",__proto__:v2,a:1337,constructor:v4};
const v7 = {};
let v8 = v7;
const v9 = [];
...
v79[1] = "MIN_VALUE";
const v80 = {get:Uint8ClampedArray};
const v82 = Object.seal(v12,65537);
}
